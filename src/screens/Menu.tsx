...
function Menu() {
  ...
  const filtroMédico = (datoMedico: string) => {
    var resultado = data1.filter((elemento: any) => {
      if (
        elemento.nombre.toLowerCase().includes(datoMedico.toLowerCase()) &&
    ...
    <>
      ...
      <div className="container px-2 ">
        ...
        <div className="8bnm">
          ...
          <br />
          <Alert color="primary" isOpen={isClicked} toggle={onDismiss}>
      ...
      <Modal isOpen={modalInsertar} size={"xl"} fade hover>
        ...
        <ModalBody>
          <FormGroup>
            ...
            <CButton
              color="success"
              onClick={() => filtroMédico(filtroValorClinica)}
              text="Filtro"
            ></CButton>
            <br />
